// Find Pattern
// Your task is simple given a string word and a string pattern . Your task is to count the number of positions where the string pattern occurs in the string word.

// Return the count of occurrences.

// Constraints:

// 1<= word.length, pattern.length  <= 10^5
...
int findPattern(string word, string pattern){
    int ret= CountPatternInText(word, pattern);
